...
(function (global, factory) {
  ...
  var Zepto = (function () {
    var undefined, key, $, classList, emptyArray = [],
      ...
      // body html  ?:匹配exp，不捕获匹配文本，也不给分组分配组号
    ...
    zepto.matches = function (element, selector) {
      ...
      //parent = tempParent;tempParent.appendChild(element);
  ...
  (function ($) {
    ...
    function triggerAndReturn(context, eventName, data) {
      ...
      $(context).trigger(event, data) //触发自定义事件
      return !event.isDefaultPrevented()
    }

    // trigger an Ajax "global" event 触发ajax的全局事件
